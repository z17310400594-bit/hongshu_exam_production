...
| WP06 | completed | 825648f | PASS | - | policy document/version/clause/eligibility MVP（87 tests, ruff 0, pyright 0, alembic clean） |
| WP07 | completed | 825648f | PASS | - | exam_event/phase/score_rule MVP（95 tests, ruff 0, pyright 0, alembic clean, smoke OK） |
| WP08 | completed | 825648f | PASS | - | content product/version/chapter MVP（103 tests, ruff 0, pyright 0, alembic clean, smoke OK） |
| WP09 | completed | 825648f | PASS | - | paper/question/question_kp MVP（110 tests, ruff 0, pyright 0, alembic clean, smoke OK） |
| WP10 | completed | 825648f | PASS | - | generation run/citation/output MVP（117 tests, ruff 0, pyright 0, alembic clean, smoke OK） |
| WP11 | completed | 825648f | PASS | - | import_batch/validation_error MVP（125 tests, ruff 0, pyright 0, alembic clean, smoke OK） |
| WP12 | completed | 825648f | PASS | - | API V2 certificates/eligibility/knowledge search MVP（130 tests, ruff 0, pyright 0, alembic clean, smoke OK） |
| WP13 | completed | 825648f | PASS | - | Taro V2 certificate/exam MVP 接入（H5 build OK, frontend type/lint no new scoped issues, backend 130 tests, ruff 0, pyright 0, alembic clean） |
| WP14 | completed | 825648f | PASS | - | 生成流程最小后端化（133 tests, ruff 0, pyright 0, alembic clean, real API smoke OK, H5 build OK, frontend type/lint no new scoped issues） |
| WP15 | completed | 825648f | PASS | - | 双读/黄金集/安全验收框架 MVP（138 tests, ruff 0, pyright 0, alembic clean, acceptance sample PASS, secret scan PASS） |
| WP16 | completed | 825648f | PASS | - | 灰度/恢复/回滚/旧库只读校验框架 MVP（142 tests, ruff 0, pyright 0, alembic clean, release sample PASS, secret scan PASS） |
